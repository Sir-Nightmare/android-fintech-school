...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        // TODO вывести информацию об исполнителе в элемент списка
        // TODO по клику на элемент списка должна показываться подробная информация об исполнителе
    }
    ...
    // TODO реализовать паттерн ViewHolder
